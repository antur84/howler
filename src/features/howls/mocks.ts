...
const mockHowls: Howl[] = [
  ...
  },
  {
    ...
    content:
      'Hot take: tabs are superior to spaces and I will not be taking questions at this time.',
  ...
  },
  {
    ...
    content:
      'Spent 3 hours debugging only to find a missing semicolon. Classic Thursday.',
  ...
  },
  {
    ...
    content:
      'The new React docs are incredible. Finally understanding Suspense after all this time.',
  ...
  },
  {
    ...
    content:
      'Who else writes "TODO: fix later" knowing full well that later never comes?',
